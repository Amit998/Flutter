...
class LookAlike extends StatefulWidget {
  @override
  _LookAlikeState createState() => new _LookAlikeState();
}

class _LookAlikeState extends State<LookAlike>
  ...
  void initState() {
    ...
    cardAnimation = Tween(begin: 0.0, end: -0.010).animate(
    ...
    fabButtonanim = Tween(begin: 1.0, end: -0.02).animate(CurvedAnimation(
