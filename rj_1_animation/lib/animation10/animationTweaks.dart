...
class AnimationTwearks extends StatefulWidget {
  @override
  _AnimationTwearksState createState() => _AnimationTwearksState();
}

class _AnimationTwearksState extends State<AnimationTwearks> {
  int photoIndex = 0;
  List<String> photos = [
    'assets/burger1.jpg',
    'assets/burger2.jpg',
